...
window.VOTE_PAGE_LOCALES.it = {
    ...
    heroVoteCta: "Vota ora",
    heroVotedCta: "Hai già votato oggi",
    ...
    voteFavorite: "Vota il tuo preferito",
    votePhaseCopy: "Scegli una categoria, poi vota il creator che vuoi sostenere oggi.",
    voteSearchPlaceholder: "Cerca per nome del creator",
    voteRulesTitle: "Come funziona la votazione",
    voteRule1: '<span class="rule-phase">Scegli una categoria</span><br /><br />Inizia selezionando Illustratori, Scrittori o Influencer.',
    voteRule2: '<span class="rule-phase">Vota un creator</span><br /><br />Scegli il creator che vuoi sostenere in quella categoria.',
    voteRule3: '<span class="rule-phase">Condividi il tuo voto</span><br /><br />Una volta espresso il voto, puoi condividere la tua card di voto sui social media.',
    shareVoteText: "Ho votato per il mio {category} preferito {name} nei Favorite Creator Awards del server Discord ZoNa Nakama.",
    voteSubmitting: "Invio del voto...",
    voteSubmitError: "Impossibile inviare il tuo voto.",
    voteEndpointMissing: "La votazione non è ancora configurata.",
    voteClosed: "La votazione è chiusa.",
    voteAlready: "Hai già votato oggi.",
    voteInvalidCreator: "Questo creator non è disponibile per il voto.",
    voteTryAgain: "Si è verificato un problema durante la verifica del voto. Riprova.",
    ...
    suggestionCreatorsDescription: "Questi sono i creator approvati finora. Ne appariranno altri man mano che i moderatori esamineranno e approveranno nuovi suggerimenti.",
    voteCreatorsDescription: "Questi sono tutti i creator per cui puoi votare.",
    slideshow: "Casuale",
    ...
    submitRateHourly: "Hai gia inviato diversi suggerimenti. Aspetta un po' prima di inviarne un altro.",
    submitRateDaily: "Hai raggiunto il limite di suggerimenti per oggi. Torna domani.",
    submitDuplicate: "Hai gia suggerito questo creator da questo browser.",
    submitTryAgain: "Si e verificato un problema durante la verifica del suggerimento. Riprova.",
