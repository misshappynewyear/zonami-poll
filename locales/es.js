...
window.VOTE_PAGE_LOCALES.es = {
    ...
    heroVoteCta: "Vota ahora",
    heroVotedCta: "Ya votaste hoy",
    ...
    voteFavorite: "Vota por tu favorito",
    votePhaseCopy: "Elige una categoría y luego vota por el creador que quieres apoyar hoy.",
    voteSearchPlaceholder: "Buscar por nombre del creador",
    voteRulesTitle: "Cómo funciona la votación",
    voteRule1: '<span class="rule-phase">Elige una categoría</span><br /><br />Empieza seleccionando Ilustradores, Escritores o Influencers.',
    voteRule2: '<span class="rule-phase">Vota por un creador</span><br /><br />Elige al creador que quieres apoyar en esa categoría.',
    voteRule3: '<span class="rule-phase">Comparte tu voto</span><br /><br />Una vez emitido tu voto, puedes compartir tu tarjeta de votación en redes sociales.',
    shareVoteText: "Voté por mi {category} favorito {name} en los Favorite Creator Awards del servidor de Discord ZoNa Nakama.",
    voteSubmitting: "Enviando tu voto...",
    voteSubmitError: "No se pudo enviar tu voto.",
    voteEndpointMissing: "La votación aún no está configurada.",
    voteClosed: "La votación está cerrada.",
    voteAlready: "Ya votaste hoy.",
    voteInvalidCreator: "Este creador no está disponible para votar.",
    voteTryAgain: "Hubo un problema al validar tu voto. Inténtalo otra vez.",
    ...
    suggestionCreatorsDescription: "Estos son los creadores aprobados hasta ahora. Irán apareciendo más a medida que los mods revisen y aprueben nuevas sugerencias.",
    voteCreatorsDescription: "Estos son todos los creadores por los que puedes votar.",
    slideshow: "Aleatorio",
    ...
    submitRateHourly: "Ya enviaste varias sugerencias. Espera un poco antes de enviar otra.",
    submitRateDaily: "Ya alcanzaste el limite de sugerencias de hoy. Vuelve manana.",
    submitDuplicate: "Ya sugeriste a este creador desde este navegador.",
    submitTryAgain: "Hubo un problema al validar tu sugerencia. Intentalo otra vez.",
