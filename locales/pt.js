...
window.VOTE_PAGE_LOCALES.pt = {
    ...
    heroVoteCta: "Vote agora",
    heroVotedCta: "Você já votou hoje",
    ...
    voteFavorite: "Vote no seu favorito",
    votePhaseCopy: "Escolha uma categoria e depois vote no criador que você quer apoiar hoje.",
    voteSearchPlaceholder: "Buscar por nome do criador",
    voteRulesTitle: "Como a votação funciona",
    voteRule1: '<span class="rule-phase">Escolha uma categoria</span><br /><br />Comece selecionando Ilustradores, Escritores ou Influenciadores.',
    voteRule2: '<span class="rule-phase">Vote em um criador</span><br /><br />Escolha o criador que você quer apoiar nessa categoria.',
    voteRule3: '<span class="rule-phase">Compartilhe seu voto</span><br /><br />Depois de votar, você pode compartilhar seu cartão de votação nas redes sociais.',
    shareVoteText: "Votei no meu {category} favorito {name} no Favorite Creator Award do servidor do Discord ZoNa Nakama.",
    voteSubmitting: "Enviando seu voto...",
    voteSubmitError: "Não foi possível enviar seu voto.",
    voteEndpointMissing: "A votação ainda não está configurada.",
    voteClosed: "A votação está fechada.",
    voteAlready: "Você já votou hoje.",
    voteInvalidCreator: "Este criador não está disponível para votação.",
    voteTryAgain: "Houve um problema ao validar seu voto. Tente novamente.",
    ...
    suggestionCreatorsDescription: "Estes são os criadores aprovados até agora. Outros vão aparecer aqui à medida que a moderação revisar e aprovar novas sugestões.",
    voteCreatorsDescription: "Estes são todos os criadores em que você pode votar.",
    slideshow: "Aleatório",
