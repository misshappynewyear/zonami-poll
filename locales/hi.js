...
window.VOTE_PAGE_LOCALES.hi = {
    ...
    heroCta: "अभी सुझाएँ",
    heroVoteCta: "अभी वोट दें",
    heroVotedCta: "आप आज पहले ही वोट कर चुके हैं",
    ...
    voteFavorite: "अपने पसंदीदा को वोट दें",
    votePhaseCopy: "एक श्रेणी चुनें, फिर उस क्रिएटर को वोट दें जिसे आप आज समर्थन देना चाहते हैं।",
    voteSearchPlaceholder: "क्रिएटर के नाम से खोजें",
    voteRulesTitle: "वोटिंग कैसे काम करती है",
    voteRule1: '<span class="rule-phase">एक श्रेणी चुनें</span><br /><br />इलस्ट्रेटर्स, राइटर्स या इन्फ्लुएंसर्स में से चुनकर शुरू करें।',
    voteRule2: '<span class="rule-phase">एक क्रिएटर को वोट दें</span><br /><br />उस श्रेणी में जिस क्रिएटर को आप समर्थन देना चाहते हैं, उसे चुनें।',
    voteRule3: '<span class="rule-phase">अपना वोट साझा करें</span><br /><br />वोट देने के बाद आप अपना वोटिंग कार्ड सोशल मीडिया पर साझा कर सकते हैं।',
    shareVoteText: "मैंने ZoNa Nakama Discord Server Favorite Creator Award में अपने पसंदीदा {category} {name} को वोट दिया।",
    voteSubmitting: "आपका वोट भेजा जा रहा है...",
    voteSubmitError: "आपका वोट भेजा नहीं जा सका।",
    voteEndpointMissing: "वोटिंग अभी सेट नहीं है।",
    voteClosed: "वोटिंग अभी बंद है।",
    voteAlready: "आप आज पहले ही वोट कर चुके हैं।",
    voteInvalidCreator: "यह क्रिएटर वोट के लिए उपलब्ध नहीं है।",
    voteTryAgain: "आपके वोट की जांच में समस्या हुई। कृपया फिर से कोशिश करें।",
    ...
    suggestionCreatorsDescription: "ये अब तक स्वीकृत किए गए क्रिएटर्स हैं। जैसे-जैसे मॉड्स नए सुझावों की समीक्षा कर उन्हें मंजूरी देंगे, यहाँ और क्रिएटर्स दिखाई देंगे।",
    voteCreatorsDescription: "ये सभी वे क्रिएटर हैं जिन्हें आप वोट दे सकते हैं।",
    slideshow: "रैंडम",
