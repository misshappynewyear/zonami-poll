...
window.VOTE_PAGE_LOCALES.id = {
    ...
    heroVoteCta: "Vote sekarang",
    heroVotedCta: "Kamu sudah vote hari ini",
    ...
    voteFavorite: "Pilih favoritmu",
    votePhaseCopy: "Pilih kategori, lalu vote kreator yang ingin kamu dukung hari ini.",
    voteSearchPlaceholder: "Cari berdasarkan nama kreator",
    voteRulesTitle: "Cara voting bekerja",
    voteRule1: '<span class="rule-phase">Pilih kategori</span><br /><br />Mulailah dengan memilih Ilustrator, Penulis, atau Influencer.',
    voteRule2: '<span class="rule-phase">Vote satu kreator</span><br /><br />Pilih kreator yang ingin kamu dukung di kategori tersebut.',
    voteRule3: '<span class="rule-phase">Bagikan votemu</span><br /><br />Setelah vote dikirim, kamu bisa membagikan kartu votingmu di media sosial.',
    ...
    suggestionCreatorsDescription: "Ini adalah kreator yang sudah disetujui sejauh ini. Lebih banyak akan muncul di sini saat para mod meninjau dan menyetujui pengajuan baru.",
    voteCreatorsDescription: "Ini semua kreator yang bisa kamu pilih.",
    slideshow: "Acak",
    artists: "Ilustrator",
