...
window.VOTE_PAGE_LOCALES.fr = {
    ...
    heroCta: "Proposer",
    heroVoteCta: "Voter maintenant",
    heroVotedCta: "Vous avez deja vote aujourd'hui",
    ...
    voteFavorite: "Votez pour votre prefere",
    votePhaseCopy: "Choisissez une categorie, puis votez pour le createur que vous voulez soutenir aujourd'hui.",
    voteSearchPlaceholder: "Rechercher par nom de createur",
    voteRulesTitle: "Comment fonctionne le vote",
    voteRule1: '<span class="rule-phase">Choisissez une categorie</span><br /><br />Commencez par selectionner Illustrateurs, Auteurs ou Influenceurs.',
    voteRule2: '<span class="rule-phase">Votez pour un createur</span><br /><br />Choisissez le createur que vous voulez soutenir dans cette categorie.',
    voteRule3: '<span class="rule-phase">Partagez votre vote</span><br /><br />Une fois votre vote envoye, vous pouvez partager votre carte de vote sur les reseaux sociaux.',
    shareVoteText: "J'ai vote pour mon {category} prefere {name} dans les Favorite Creator Awards du serveur Discord ZoNa Nakama.",
    voteSubmitting: "Envoi de votre vote...",
    voteSubmitError: "Impossible d'envoyer votre vote.",
    voteEndpointMissing: "Le vote n'est pas encore configure.",
    voteClosed: "Le vote est actuellement ferme.",
    voteAlready: "Vous avez deja vote aujourd'hui.",
    voteInvalidCreator: "Ce createur n'est pas disponible pour le vote.",
    voteTryAgain: "Un probleme est survenu lors de la validation de votre vote. Veuillez reessayer.",
    ...
    suggestionCreatorsDescription: "Voici les createurs approuves jusqu'a present. D'autres apparaitront au fur et a mesure que les moderateurs examineront et approuveront de nouvelles suggestions.",
    voteCreatorsDescription: "Voici tous les createurs pour lesquels vous pouvez voter.",
    slideshow: "Aleatoire",
